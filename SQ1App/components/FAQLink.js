...
function FAQLink({setIsFAQModalVisible}){
    const ref = useRef(null);
    const [canGoBack, setCanGoBack] = useState(false);
    const [canGoForward, setCanGoForward] = useState(false);
    const [currentUrl, setCurrentUrl] = useState("https://docs.google.com/document/d/1C8FsdyvHoIzaNNClsHCejFF0SXr1VOaxUN8RxCT9N-0/edit?usp=sharing")
    ...
    return(
        <View style={styles.websiteLinkContainer}>
            ...
            <View style={styles.topNavBar}>
                ...
                <View>
                    <Text style={styles.webTitle}>FAQs</Text>
                </View>
                <TouchableOpacity onPress={()=>setIsFAQModalVisible(false)}>
